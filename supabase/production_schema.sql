-- ============================================================
-- PRODUCTION DPR & WIP CONTROL — SCHEMA V4
...
-- V4 adds editable WIP cell audit/backdate support and keeps production_* tables separate from Merch Tracker.
-- ============================================================
...
-- Patch V4 backdated audit columns for projects that already ran V3.
